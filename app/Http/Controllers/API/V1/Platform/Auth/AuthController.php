...
use App\Http\Requests\Platform\Auth\PasswordUpdateRequest;
use App\Http\Requests\Platform\Auth\ProfileUpdateRequest;
use App\Http\Requests\Platform\Auth\UpdateProfileImageRequest;
...
class AuthController extends Controller
{
     ...
     */
    public function updateProfileImage(UpdateProfileImageRequest $request): \Illuminate\Http\JsonResponse
    {
        $validatedData = $request->validated();
        try {
