                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="mb-3">
                                            ...
                                            <input type="date"
                                                ...
                                                name="start_date" value="{{ $coupon?->getRawOriginal('start_date') }}"
                                    ...
                                    <div class="col-lg-12 mb-2">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="coupon_description"
                                            placeholder="Enter coupon description" rows="5">{{ $coupon?->description }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                                ...
                                                @isset($couponAmountTypes)
                                                    @foreach ($couponAmountTypes as $couponAmountType)
                                                        <option value="{{ $couponAmountType?->value }}"
                                                            @selected($couponAmountType?->value == $coupon?->amount_type->value)>
                                    ...
                                    <div class="col-12 mb-2">
                                        <div class="mb-3">
                                            <label class="form-label">Allowed Time <i
                                                    class="ri ri-information-fill text-info" data-bs-container="body"
                                                    data-bs-toggle="popover" data-bs-placement="top"
                                                    data-bs-content="Please input the number of times the coupon can be used, or alternatively, select the 'unlimited' option if you wish to utilize it an unlimited number of times."></i></label>
                                            <input type="number" min="0" step="0.01"
                                                class="form-control @error('allowed_time') is-invalid @enderror"
                                                name="allowed_time" id="allowed_time" value="{{ $coupon?->allowed_time }}"
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="is_unlimited"
                                                    name="is_unlimited" value="1" @checked($coupon?->is_unlimited?->value) />
