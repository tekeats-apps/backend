                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-2">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        name="name" value="{{ old('name', isset($product) ? $product->name : '') }}"
                            ...
                            <div class="col-lg-6 mb-2">
                                <div class="mb-3">
                                    <label for="product-tags-field" class="form-label">Product Tags | Keywords</label>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check form-switch form-switch-lg form-switch-success">
                                    <input class="form-check-input @error('extras') is-invalid @enderror" type="checkbox"
                                        name="extras" id="extras" value="1"
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check form-switch form-switch-lg form-switch-success">
                                    <input class="form-check-input @error('is_variants_enabled') is-invalid @enderror"
                                    ...
                                    <label class="form-check-label" for="is_variants_enabled">Enable Variants</label>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check form-switch form-switch-lg form-switch-success">
                                    <input
                                        ...
                                        type="checkbox" name="is_product_timing_enabled" id="is_product_timing_enabled"
                                        value="1"
