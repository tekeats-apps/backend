<div class="tab-pane fade" id="custom-v-pills-delivery-settings" role="tabpanel"
    aria-labelledby="custom-v-pills-delivery-settings-tab">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-2">
                            ...
                            <p class="text-muted">Allow the inclusion of additional charges for special circumstances
