                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('title') is-invalid @enderror"
                                                name="title" value="{{ old('title') }}" placeholder="Enter tax title" required>
                                            @error('title')
                                    ...
                                    <div class="col-12 mb-2">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('type') is-invalid @enderror"
                                                name="type" id="plugin_type" required>
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="form-check form-switch form-switch-lg form-switch-success">
                                            <input
                                                ...
                                                type="checkbox" name="active" id="active" value="1" {{ old('active') }}>
