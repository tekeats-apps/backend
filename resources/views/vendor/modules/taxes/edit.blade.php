                                        ...
                                        <select class="js-example-basic-multiple" name="categories[]" multiple="multiple">
                                            @isset($categories)
                                                @foreach ($categories as $key => $category)
                                                    <option value="{{ $category?->id }}" @selected($tax?->categories->contains('id', $category?->id))>{{ $category?->name }}</option>
                                                @endforeach
                                            @endisset
                                        </select>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <select class="js-example-basic-multiple" name="products[]" multiple="multiple">
                                            @isset($products)
                                                ...
                                                <option value="{{ $product?->id }}" @selected($tax->products->contains('id', $product->id))>{{ $product?->name }}</option>
                                                @endforeach
                                            @endisset
                                        </select>
                                    </div>
