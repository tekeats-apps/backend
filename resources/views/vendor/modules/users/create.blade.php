...
@section('content')
    ...
    <form id="users-form" action="{{ route('vendor.users.store') }}" method="POST" autocomplete="off"
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">User Information <span class="float-end">
                                <a href="{{ route('vendor.users.list') }}" class="btn btn-info bt-sm">Back to Users</a>
                            </span></h5>
