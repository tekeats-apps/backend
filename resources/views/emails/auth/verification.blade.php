                                ...
                                <td style="padding: 40px 0px 0px;">
                                    ...
                                    <div style="padding: 20px; background-color: rgb(255, 255, 255);">
                                        <div style="color: rgb(0, 0, 0); text-align: left;">
                                            ...
                                            <p style="padding-bottom: 16px">Hey, {{ $customer->first_name }} Please use
                                                the verification code below to
                                                verify your account.</p>
                                            <p style="padding-bottom: 16px"><strong
                                                    style="font-size: 130%">{{ $customer->otp }}</strong></p>
                                            <p style="padding-bottom: 16px">If you didn’t request this, you can ignore
                                                this email.</p>
                                            <p style="padding-bottom: 16px">Regadrs,<br> {{ config('app.name') }}
                                                Team</p>
                                        </div>
                                    </div>
                                </td>
