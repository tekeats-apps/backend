            ...
            <div class="row g-4 align-items-center">
                ...
                <div class="col-sm-auto">
                    <div class="d-flex flex-wrap align-items-start gap-2">
                        <a type="button" href="{{ route('vendor.discounts.create') }}"
                            class="btn btn-success btn-label waves-effect waves-light"><i
                                class="ri-add-line label-icon align-middle fs-16 me-2"></i> Add New Discount</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xxl-4 col-sm-12">
                    ...
                    <div class="search-box">
                        <input type="text" wire:model.debounce.500ms="search" id="search"
                            ...
                            placeholder="Search for discount title, type, amount, status or something...">
                ...
                <tbody>
                    @foreach ($discounts as $key => $discount)
                        <tr>
                            <th scope="row">
                                <div class="form-check">
                                    <input class="form-check-input fs-15" id="customer_{{ $discount?->id }}"
                            ...
                            <td>
                                <div class="dropdown d-inline-block">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a href="{{ route('vendor.discounts.edit', $discount?->id) }}"
