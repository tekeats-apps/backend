<div class="card" id="planFeaturesList">
    <div class="card-header border-0">
        <div class="d-flex align-items-center">
            <h5 class="card-title mb-0 flex-grow-1">Plan Features</h5>
            <div class="flex-shrink-0">
                <div class="d-flex gap-2 flex-wrap">
                    <button class="btn btn-primary" id="remove-actions" onClick="deleteMultiple()"><i
                            class="ri-delete-bin-2-line"></i></button>
                    <a href="{{ route('admin.plans.features.create') }}" class="btn btn-success"><i
                            class="ri-add-line align-bottom me-1"></i> Create Plan Features</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <table class="table align-middle mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        <th class="sort text-uppercase" scope="col">Feature Name
                        </th>
                        <th class="sort text-uppercase" scope="col">Feature Description</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" href="{{ route('admin.plans.features.edit', $planFeature?->id) }}" data-id="{{ $planFeature?->id }}">
                                        ...
                                        <li><a class="dropdown-item" href="javascript:void(0);" data-id="">
                                                ...
                                                View</a></li>
                                        <li>
                                            <a class="dropdown-item" wire:click="confirmDelete('{{ $planFeature?->id }}')"
