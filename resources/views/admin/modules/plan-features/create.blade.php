...
@section('content')
    ...
    @component('admin.layouts.components.breadcrumb')
        ...
        @endslot
    @endcomponent
    <form id="plan-feature-form" action="{{ route('admin.plans.features.store') }}" method="POST" autocomplete="off">
        @csrf
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('feature_name') is-invalid @enderror"
                                        name="feature_name" value="{{ old('feature_name') ?? '' }}" id="feature_name"
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('feature_description') is-invalid @enderror" name="feature_description"
                                        placeholder="Enter feaure description" id="feature_description">{{ old('feature_description') ?? '' }}</textarea>
