            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mt-sm-5 mb-4 text-purple-50">
                        ...
                        <p class="mt-3 fs-15 fw-medium">FoeZy</p>
                    </div>
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> FoEZy <i class="mdi mdi-heart text-danger"></i></p>
                    </div>
                </div>
            </div>
        </div>
